...
<script src="<?php echo e(asset('js/toastr.js')); ?>"></script>
    ...
    <div class="card-header" style="background:maroon; color:white;">
            Item Attribute
            <button type="button" class="pull-right btn btn-outline-light btn-sm" data-toggle="popover" title="Help" data-html="true" data-content="All deactivated item attributes are listed here."><i class="fa fa-question-circle" aria-hidden="true"></i></button>
    </div>
