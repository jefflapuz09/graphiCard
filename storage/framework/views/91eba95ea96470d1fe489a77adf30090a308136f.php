...
<header class="masthead top text-center" style="background-image: url('<?php echo e(asset('img/sample1.png')); ?>')">
...
<!-- Page Content -->
<header class="masthead top text-center" style="background-image: url('<?php echo e(asset('img/sample2.png')); ?>')">
  <div class="overlay"></div>
  <div class="container">
    <div class="col-xl-12 mx-auto">
