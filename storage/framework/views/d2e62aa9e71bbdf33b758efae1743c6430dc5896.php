...
<div class="container mt-5">
    <div class="container">
        ...
        <hr class="colorgraph">     
            <form action="<?php echo e(url('/customer/cartPack/'.$post->id)); ?>" method="post" files="true" enctype="multipart/form-data">           
        <div class="row">
            ...
            <div class="col-sm-8 mt-3 card">
                <?php $__currentLoopData = $post->Inclusion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inclusion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p class="lead p-3"><?php echo e($inclusion->ItemPack->name); ?>(<?php echo e($inclusion->qty); ?>)</p>
                    <input type="hidden" value="<?php echo e($inclusion->ItemPack->name); ?>" name="packItem[]">
